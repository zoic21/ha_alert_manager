...
export const MDI_INFORMATION_OUTLINE = "M11,9H13V7H11M12,20C7.58,20 4,16.42 4,12C4,7.58 7.58,4 12,4C16.42,4 20,7.58 20,12C20,16.42 16.42,20 12,20M12,2C6.48,2 2,6.48 2,12C2,17.52 6.48,22 12,22C17.52,22 22,17.52 22,12C22,6.48 17.52,2 12,2M11,17H13V11H11V17Z";
...
export { TRANSITION_RULE_SOURCES, TABS, MDI_CLOSE, MDI_PLUS, MDI_ALERT_CIRCLE_OUTLINE, MDI_CLOCK_OUTLINE, MDI_CHECK_CIRCLE_OUTLINE, MDI_DOTS_VERTICAL, MDI_DOWNLOAD, MDI_UPLOAD, MDI_FILTER_VARIANT_REMOVE, MAX_DURATION_SECONDS, MIN_NOTIFICATION_REMINDER_SECONDS, DEFAULT_NOTIFICATION_REMINDER_SECONDS, TEXT_RULE_OPERATORS, RANGE_RULE_OPERATORS, ATTRIBUTE_RULE_SOURCES, VARIATION_RULE_SOURCES, VARIATION_RULE_OPERATORS, ALERT_MANAGER_ENTITY_IDS, CUSTOM_RULE_EXCLUDED_ENTITY_IDS, ACTION_ICONS };
