...
import { MAX_DURATION_SECONDS, MDI_ALERT_CIRCLE_OUTLINE, MDI_CHECK_CIRCLE_OUTLINE, MDI_CLOCK_OUTLINE, MDI_DOTS_VERTICAL, MDI_FILTER_VARIANT_REMOVE, TABS, TRANSITION_RULE_SOURCES } from "../utils/constants.js";
...
export function loadNativeLabels(hass) {
...
export function nativeLabelBadges(metadataList, hass) {
