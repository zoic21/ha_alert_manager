...
INTEGRATION_VERSION: Final = "2.2.0-beta.10"
FRONTEND_CACHE_VERSION: Final = f"{INTEGRATION_VERSION}.26"
...
PENDING_PERSISTENCE_RETRY_SECONDS: Final = 60
...
NOTIFICATION_STORAGE_KEY: Final = f"{DOMAIN}.notifications"
STORAGE_VERSION: Final = 1
STORAGE_MINOR_VERSION: Final = 16
HISTORY_STORAGE_VERSION: Final = 1
COHERENCE_STORAGE_VERSION: Final = 1
CONFIG_BACKUP_STORAGE_VERSION: Final = 1
NOTIFICATION_STORAGE_VERSION: Final = 1
...
MAX_NOTIFICATION_TARGETS: Final = 20
MAX_NOTIFICATION_EXCEPTIONS: Final = 100
MAX_NOTIFICATION_LABELS: Final = 100
MAX_NOTIFICATION_PROFILE_NAME_LENGTH: Final = 255
NOTIFICATION_BATCH_SECONDS: Final = 30
MIN_NOTIFICATION_REMINDER_INTERVAL: Final = 60
