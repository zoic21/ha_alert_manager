    ...
    return `<form id="settings-form" class="stack">
      <section class="panel"><h2>${esc(this._t("settings.general"))}</h2><div class="fields">
        ...
        <div class="history-settings full">
          <div><h3>${esc(this._t("settings.history_title"))}</h3><small>${esc(this._t("settings.history_help"))}</small></div>
          <div class="history-settings-row">
            ${this._numberField("history-limit", this._t("settings.history_limit"), this._historyConfig.retention_limit, this._t("units.events"), 0, 1000)}
  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}main{max-width:1400px;margin:0 auto;padding:24px}h2{font-size:var(--ha-font-size-xl,20px);font-weight:var(--ha-font-weight-normal,400);line-height:var(--ha-line-height-condensed,1.4);margin:0 0 6px}p{margin:0;color:var(--secondary-text-color,#727272)}
      ...
      .alert-card.is-resolved,.device-alert-group.is-resolved,.device-alert-row.is-resolved{--alert-state-color:var(--secondary-text-color,#727272)}.history-card .alert-title code,.history-device-row code{margin-top:2px}.history-status{font-weight:var(--ha-font-weight-medium,500);color:var(--secondary-text-color,#727272)}.history-device-row{grid-template-columns:32px minmax(0,1.25fr) auto}.device-alert-message{grid-column:2/-1;min-width:0}.device-alert-message small,.device-alert-message span{display:block}.history-empty .empty h2{margin-bottom:8px}.history-empty .empty ha-button{margin-top:16px}.history-settings{display:grid;gap:12px;margin-top:4px}.history-settings h3{margin:0}.history-settings-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:16px}.history-actions{align-self:end;justify-content:flex-start;flex-wrap:nowrap}
