...
class AlertManagerPanel extends HTMLElement {
  ...
  _renderOverviewAlerts(items) {
    ...
    const renderItems = (statusItems, status) => statusItems.length
      ? `<div class="alert-list alert-list-${status}">
    ...
    return `<section class="alert-group">
      ...
      ${renderItems(activeItems, "active")}
