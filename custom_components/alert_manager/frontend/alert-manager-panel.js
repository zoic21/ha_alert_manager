Warning: truncated output (original token count: 71853)
Total output lines: 7242
...
function captureRuleDraftFromForm(form, currentRule = {}, selectorValues = {}) {
 ...
 …21853 tokens truncated… "" : renderNumberField(`auto-${pack.id}-delay`, t("automatic.pack_delay"), packConfig.delay, t("units.seconds"), 0, 31536000, { required: false, help: t("automatic.empty_delay_help") })}
