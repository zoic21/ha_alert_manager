...
class AlertManagerPanel extends HTMLElement {
  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}main{max-width:1400px;margin:0 auto;padding:24px}h2{font-size:19px;margin:0 0 6px}p{margin:0;color:var(--secondary-text-color,#727272)}
